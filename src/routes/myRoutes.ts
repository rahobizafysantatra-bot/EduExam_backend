...
router.get('/exams/:examId', authMiddleware, requireRole('STUDENT'), AttemptController.getMyExam);
router.post('/exams/:examId/submit', authMiddleware, requireRole('STUDENT'), AttemptController.submitExam);
